...
class SubmissionForm(Form):
    ...
    sector_preference = RadioField('Title', coerce=int, choices=[('Financial Sector'),('Technology Sector'),('Utilities'), ('Healthcare'), ('Energy'),('Consumer Staples'),('Commodities'),('Real Estate')])
    ...
    poor_expectations = RadioField('Title', coerce=int, choices=[('5','To make losses'),('4','To make very little or break even'),('3','To make out a little gain, i.e. 2-5%'), ('2','To make a modest gain'), ('1','To be affected little by the broader stock market movements')])
